...
describe 'cloudera::search::repo', :type => 'class' do
  ...
  context 'on a supported operatingsystem, custom parameters' do
    ...
    describe 'ensure => absent' do
      ...
      it { should contain_yumrepo('cloudera-search').with_enabled('0') }
      it { should contain_file('/etc/yum.repos.d/cloudera-search.repo').with_ensure('file') }
    end
