...
description 'This module manages the installation of Cloudera's Distribution, including Apache Hadoop (CDH) and Cloudera Manager. It follows the standards written in the Cloudera Manager Installation Guide Installation Path B - Installation Using Your Own Method. It also includes installing the beta version of Cloudera Impala.'
